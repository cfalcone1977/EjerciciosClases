export class Libro{
    ...
    activo:boolean;
    isbn: string;
    constructor(Autor:string, Titulo:string, Genero:string, Tipo:string,Paginas:number,Activo:boolean, ISBN:string){
          this.autor=Autor;
          this.titulo=Titulo;
          this.genero=Genero;
          this.tipo=Tipo;
 ...
 export class GestorLibros{
    ...
    insertarLibro(nuevoLibro:Libro){ 
    let posicion:number;
    ...
    consultarLibro(isbn:string){
        let posicion:number=this.buscarLibroISBN(isbn);
        if (posicion!=-1){
          console.warn(!this.arrayLibros[posicion].activo?"***LIBRO CON BAJA LOGICA***":"");
          console.warn("***MOSTRANDO LIBRO***");
          console.log("********************** LIBRO ************************");
          console.log(`Titulo: ${this.arrayLibros[posicion].titulo}`);
          console.log(`Autor: ${this.arrayLibros[posicion].autor}`);
          console.log(`Tipo: ${this.arrayLibros[posicion].tipo}`);
          console.log(`Paginas: ${this.arrayLibros[posicion].paginas}`);
          this.arrayLibros[posicion].activo?console.log(`Activo: ${this.arrayLibros[posicion].activo}`):console.warn(`Activo: ${this.arrayLibros[posicion].activo}`);        
          console.log(`Genero: ${this.arrayLibros[posicion].genero}`);
          console.log(`ISBN: ${this.arrayLibros[posicion].isbn}`);
          console.log("*****************************************************");
                        } else {
