...
var librosDatos_1 = require("./librosDatos");
var ManejoLibros = new librosDatos_1.GestorLibros(librosDatos_1.arregloLibros);
var libro1 = { autor: "NuevoGeorge Orwell", titulo: "N1984", genero: "NCiencia Ficcion", tipo: "Nuevonovela", paginas: 195, activo: true, isbn: "N978-0451524935" };
var libro2 = { autor: "Cristian Falcone", titulo: "Naranjito", genero: "Infantil", tipo: "Cuento", paginas: 222, activo: true, isbn: "NCOF-207420" };
var libroaModificar = { autor: "Autor_Modificado", titulo: "Titulo_Modificado", genero: "Genero_Modificado", tipo: "Tipo_Modificado", paginas: 158, activo: true, isbn: "978-0743273565" };
